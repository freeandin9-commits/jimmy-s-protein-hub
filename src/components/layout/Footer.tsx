          ...
          <div className="flex flex-wrap gap-3">
            {settings.instagram_url && (
              <a
                ...
                className="rounded-full border border-border p-2 transition-colors hover:border-[#E1306C] hover:text-[#E1306C]"
              >
            ...
            {settings.facebook_url && (
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="rounded-full border border-border p-2 transition-colors hover:border-[#1877F2] hover:text-[#1877F2]"
              >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="rounded-full border border-border p-2 transition-colors hover:border-[#25D366] hover:text-[#25D366]"
            >
