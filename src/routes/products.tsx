...
function ProductsPage() {
  ...
  // Admin-ൽ നിന്ന് സെറ്റ് ചെയ്യുന്ന സൈഡ് ബാനർ ഇമേജുകൾ എടുക്കുന്നു (settings-ൽ banner_urls ഉണ്ടെന്ന് കരുതുന്നു)
  // ഇല്ലെങ്കിൽ അഡ്മിൻ പാനലിൽ ഉള്ള ഫീൽഡിന്റെ പേര് അനുസരിച്ച് ഇതിൽ മാറ്റം വരുത്താം.
  const sideBanners = useMemo(() => {
    if (!settings) return [];
    return [settings.shop_side_banner_1, settings.shop_side_banner_2].filter(Boolean) as string[];
  }, [settings]);
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
          <aside className="lg:sticky lg:top-24 lg:self-start flex flex-col gap-6">
            ...
            {/* ADMIN DRIVEN SIDE BANNER IMAGES */}
