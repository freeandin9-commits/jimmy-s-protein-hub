...
function HomePage() {
  ...
  const [isMuted, setIsMuted] = useState(false); // Changed to false by default for sound on
  ...
  return (
    <div className="relative w-full">
      ...
      >
        {/* ... existing background visuals remain same ... */}
        <div
          aria-hidden
      ...
      {/* ... rest of the page code (Benefits, Products, etc) ... */}
    </div>
  );
}
